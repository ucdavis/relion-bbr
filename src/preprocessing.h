...
public:
	...
	////	add noise.
	bool do_addnoise,fourier_add_noise;
	RFLOAT stddev_white_noise;
	////
	////	add pre-given ice background.
	bool do_add_ice_background;
	FileName fn_Ice_Background;
	RFLOAT Ice_Intensity;
	////
