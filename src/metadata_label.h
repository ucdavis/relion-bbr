...
enum EMDLabel
{
	...
	////For near direction restrain
	EMDL_ORIENT_ROT_NEAR,
	EMDL_ORIENT_TILT_NEAR,
	EMDL_ORIENT_DELTA_THETA,
	EMDL_WEIGHT_VECT_X,
	EMDL_WEIGHT_VECT_Y,
	EMDL_WEIGHT_VECT_Z,
	EMDL_WEIGHT_VECT_VALUE,
	////
	
	////BBR
	EMDL_BBR_DELTA_Z,
	EMDL_BBR_PARTICLE_SERIAL_NUM,
	////
...
////
		EMDL::addLabel(EMDL_ORIENT_ROT_NEAR, EMDL_DOUBLE, "rlnAngleRotNear", "nearest section of rot (rot, in degrees)");
		EMDL::addLabel(EMDL_ORIENT_TILT_NEAR, EMDL_DOUBLE, "rlnAngleTiltNear", "nearest section of tilt (tilt, in degrees)");
		EMDL::addLabel(EMDL_ORIENT_DELTA_THETA, EMDL_DOUBLE, "rlnAngleDeltaTheta", "distance to nearest section (theta, in degrees)");
		EMDL::addLabel(EMDL_WEIGHT_VECT_X, EMDL_DOUBLE, "rlnWeightVectorX", "Normalized Vector_X for orientation prior.");
		EMDL::addLabel(EMDL_WEIGHT_VECT_Y, EMDL_DOUBLE, "rlnWeightVectorY", "Normalized Vector_Y for orientation prior.");
		EMDL::addLabel(EMDL_WEIGHT_VECT_Z, EMDL_DOUBLE, "rlnWeightVectorZ", "Normalized Vector_Z for orientation prior.");
		EMDL::addLabel(EMDL_WEIGHT_VECT_VALUE, EMDL_DOUBLE, "rlnWeightVectorValue", "Value of Vector for orientation prior.");
////
////BBR
		EMDL::addLabel(EMDL_BBR_DELTA_Z, EMDL_DOUBLE, "rlnDeltaZ", "Value of defocus change.");
		EMDL::addLabel(EMDL_BBR_PARTICLE_SERIAL_NUM, EMDL_INT, "rlnParticleSerialNumber", "Particle number of blocks.");
////
